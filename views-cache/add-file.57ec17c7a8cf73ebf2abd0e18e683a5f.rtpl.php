                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $curso, ENT_COMPAT, 'UTF-8', FALSE ); ?>/file-add" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <label for="filecurso">Arquivo</label>
                                        <div class="custom-file">
                                            <input type="file" name="filecurso" class="custom-file-input" id="filecurso">
