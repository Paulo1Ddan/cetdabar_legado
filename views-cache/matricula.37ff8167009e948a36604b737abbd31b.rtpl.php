                                        ...
                                        <tbody>
                                            <?php $counter1=-1;  if( isset($matricula) && ( is_array($matricula) || $matricula instanceof Traversable ) && sizeof($matricula) ) foreach( $matricula as $key1 => $value1 ){ $counter1++; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>     
                                                        <a href="/cetdabar/admin/matricula/<?php echo htmlspecialchars( $value1["idmatricula"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-eye"></i> Ver Registro</a>               
