                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <a href="/cetdabar/admin/cursos/curso-add" class="btn btn-primary">Cadastrar curso</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            <?php $counter1=-1;  if( isset($cursos) && ( is_array($cursos) || $cursos instanceof Traversable ) && sizeof($cursos) ) foreach( $cursos as $key1 => $value1 ){ $counter1++; ?>
                                                <?php if( $value1["statuscurso"] == 1 ){ ?>
                                                    <?php $value1["statuscurso"] = "Ativo"; ?>
                                                <?php }else{ ?>
                                                    <?php $value1["statuscurso"] = "Inativo"; ?>
                                                <?php } ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars( $value1["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                                    <td><?php echo htmlspecialchars( $value1["nomecurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                                    <td><?php echo htmlspecialchars( $value1["statuscurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                                                    <td>                    
                                                        <a href="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $value1["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                                                        <a href="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $value1["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"onclick="return confirm('Deseja realmente excluir este registro?')"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
