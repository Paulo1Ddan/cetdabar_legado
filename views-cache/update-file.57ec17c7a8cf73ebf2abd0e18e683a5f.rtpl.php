                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cadastrar arquivo</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $curso, ENT_COMPAT, 'UTF-8', FALSE ); ?>/file-add"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" required name="nomecurso" value="<?php echo htmlspecialchars( $curso, ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled id="nomecurso" class="form-control" placeholder="Nome">
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" required value="<?php echo htmlspecialchars( $dataarquivo["arquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled id="nomearquivo" class="form-control" placeholder="Nome">
                                        </div>

                                        <!-- Selecionar arquivo -->
                                        <label for="filecurso">Selecionar Arquivo</label>
                                        <div class="custom-file">
                                            <input type="file" name="filecurso" class="custom-file-input"
                                                id="filecurso">
