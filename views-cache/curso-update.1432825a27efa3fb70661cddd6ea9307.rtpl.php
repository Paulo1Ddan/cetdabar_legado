                                ...
                                <form method="POST" action="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $cursodata["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" required name="nomecurso" value="<?php echo htmlspecialchars( $cursodata["nomecurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="nomecurso" class="form-control" placeholder="Nome">
                                            <input type="hidden" name="oldname" value="<?php echo htmlspecialchars( $cursodata["nomecurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" required id="instrutorcurso" name="instrutorcurso" value="<?php echo htmlspecialchars( $cursodata["instrutor"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control" placeholder="Instrutor">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $cursodata["idcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/update-img"
                                    ...
                                    <div class="form-group">
                                        <div class="card-body">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="imgcurso" class="custom-file-input"
                                                    id="imgcurso">
                                                <label class="custom-file-label" for="customFile">Escolher
                                                    Imagem</label>
                                                <div class="boxImgPreview">
                                                    <img alt="" src="/cetdabar/res/site/<?php echo htmlspecialchars( $cursodata["imgcurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                                        class="imgPreview">
                                                </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <a href="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $cursodata["nomecurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/file-add" class="btn btn-primary">Cadastrar arquivo</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                        ...
                                        <tbody>
                                            <?php $counter1=-1;  if( isset($files) && ( is_array($files) || $files instanceof Traversable ) && sizeof($files) ) foreach( $files as $key1 => $value1 ){ $counter1++; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/cetdabar/admin/cursos/<?php echo htmlspecialchars( $cursodata["nomecurso"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/file/<?php echo htmlspecialchars( $value1["idarquivo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                                                        <a href="/cetdabar/admin/cursos/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>Excluir</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
